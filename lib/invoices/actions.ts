    ...
    try {
      ...
      const calculatedItems = data.items.map((item, index) => {
        ...
        return {
          ...
          percentage: item.percentage ? item.percentage.toString() : null,
      ...
      const [invoice] = await db.transaction(async (tx) => {
        ...
        const [newInvoice] = await tx
          ...
          .values({
            ...
            contractAmount: data.contractAmount ? data.contractAmount.toString() : null,
      ...
      await db.transaction(async (tx) => {
        ...
        await tx
          ...
          .set({
            ...
            contractAmount: updateData.contractAmount ? updateData.contractAmount.toString() : null,
            subtotal: totals.subtotal,
            totalDiscount: totals.totalDiscount,
            totalTax: totals.totalTax,
            totalAmount: totals.totalAmount,
