...
export const QuotationEmail = ({
  ...
  const previewText = `Quotation ${quotationNumber} from ${businessName}`;
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={header}>
            ...
            <Text style={headerText}>Quotation</Text>
          </Section>
          ...
          <Section style={detailsBox}>
            <Row>
              <Column style={leftColumn}>
                <Text style={label}>Quotation Number:</Text>
                <Text style={value}>{quotationNumber}</Text>
              </Column>
              <Column style={rightColumn}>
                <Text style={label}>Date:</Text>
                <Text style={value}>{quotationDate}</Text>
              </Column>
            </Row>
            <Row style={{ marginTop: '12px' }}>
              <Column style={leftColumn}>
                <Text style={label}>Valid Until:</Text>
          ...
          {items.length > 0 && (
            <Section style={section}>
              <Text style={tableHeader}>Quotation Items</Text>
              <table style={table}>
                <thead>
                  <tr>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              This quotation is valid until {validUntil}. Please contact us to accept or discuss.
            </Text>
            <Text style={footerText}>
