    ...
    try {
      ...
      const [product] = await db
        ...
        .values({
          ...
          billingCycle: data.productType === 'service' ? (data.billingCycle || null) : null,
          features: data.productType === 'service' && data.features ? data.features : null,
    ...
    try {
      ...
      await db
        ...
        .set({
          ...
          billingCycle: updateData.productType === 'service' ? (updateData.billingCycle || null) : null,
          features: updateData.productType === 'service' && updateData.features ? updateData.features : null,
