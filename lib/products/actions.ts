    ...
    try {
      ...
      const [product] = await db
        ...
        .values({
          ...
          billingCycle: (data.productType === 'service' || data.productType === 'digital') ? (data.billingCycle || null) : null,
          features: (data.productType === 'service' || data.productType === 'digital') && data.features ? data.features : null,
          trackInventory: (data.productType === 'service' || data.productType === 'digital') ? false : data.trackInventory,
    ...
    try {
      ...
      await db
        ...
        .set({
          ...
          billingCycle: (updateData.productType === 'service' || updateData.productType === 'digital') ? (updateData.billingCycle || null) : null,
          features: (updateData.productType === 'service' || updateData.productType === 'digital') && updateData.features ? updateData.features : null,
          trackInventory: (updateData.productType === 'service' || updateData.productType === 'digital') ? false : updateData.trackInventory,
