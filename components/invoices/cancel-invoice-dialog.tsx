...
import { cancelInvoice } from '@/lib/invoices/actions';
        ...
        <div className="py-4 space-y-4">
          {hasPayments && (
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> This invoice has {currency} {parseFloat(amountPaid).toFixed(2)} in payments.
                These payments will be automatically reversed and returned to the customer&apos;s advance balance.
              </p>
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="e.g., Entered incorrect customer, duplicate invoice, customer requested cancellation..."
